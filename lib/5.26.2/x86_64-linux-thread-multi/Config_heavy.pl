...
config_arg2='-Dprefix=/xc.reactive_python2.7'
config_arg3='-Dusethreads'
config_arg4='-Duserelocatableinc'
config_arg5='-Dcccdlflags=-fPIC'
config_arg6='-Dldflags=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib'
...
config_arg9='-Dlddlflags=-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib'
config_argc='10'
config_args='-de -Dprefix=/xc.reactive_python2.7 -Dusethreads -Duserelocatableinc -Dcccdlflags=-fPIC -Dldflags=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib -Ddefault_inc_excludes_dot=n -Dcc=/tmp/build/80754af9/perl_1527832170752/_build_env/bin/x86_64-conda_cos6-linux-gnu-gcc -Dlddlflags=-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib -Dsysroot=/tmp/build/80754af9/perl_1527832170752/_build_env/x86_64-conda_cos6-linux-gnu/sysroot'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
inews=''
initialinstalllocation='/xc.reactive_python2.7/bin'
installarchlib='.../../lib/5.26.2/x86_64-linux-thread-multi'
installbin='/xc.reactive_python2.7/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir='.../../man/man1'
installman3dir='.../../man/man3'
installprefix='/xc.reactive_python2.7'
installprefixexp='.../..'
...
lddlflags='-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib --sysroot /tmp/build/80754af9/perl_1527832170752/_build_env/x86_64-conda_cos6-linux-gnu/sysroot -fstack-protector-strong'
ldflags='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib -fstack-protector-strong'
...
perlpath='/xc.reactive_python2.7/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth=''
...
st_ino_sign='1'
st_ino_size='8'
startperl='#!/xc.reactive_python2.7/bin/perl'
startsh='#!/bin/sh'
static_ext=' '
stdchar='char'
...
ldflags_nolargefiles='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/xc.reactive_python2.7/lib -L/xc.reactive_python2.7/lib -fstack-protector-strong'
